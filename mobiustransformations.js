...
function draw() {
  ...
  push();
  textSize(16);
  text('please refrain from', 1440 / 5, 4 * 737 / 20 + 11);
  text('using these as doing so', 1440 / 5, 4.7 * 737 / 20 + 11);
  text('breaks it and I have' , 1440 / 5, 5.4 * 737 / 20 + 11);
  text('not been able to fix it' , 1440 / 5, 6.1 * 737 / 20 + 11);
  strokeWeight(2);
  line(186, 37, 186, 246);
  line(186, 37, 156, 37);
  line(186, 246, 156, 246);
  pop();

...
function draw() {
  ...
  const xOriginPD = windowWidth / 2;
  const yOriginPD = 7 * windowHeight / 15;
  ...
  push();
  strokeWeight(6);
  if (dist(xOriginPD + leftPointPD.re * 2 * windowHeight / 5, yOriginPD - leftPointPD.im * 2 * windowHeight / 5,
          xOriginPD + rightPointPD.re * 2 * windowHeight / 5, yOriginPD - rightPointPD.im * 2 * windowHeight / 5)
          < 2 * discRadius + 0.01 && dist(xOriginPD + leftPointPD.re * 2 * windowHeight / 5, yOriginPD - leftPointPD.im * 2 * windowHeight / 5,
          xOriginPD + rightPointPD.re * 2 * windowHeight / 5, yOriginPD - rightPointPD.im * 2 * windowHeight / 5)
          > 2 * discRadius - 0.01) {
    stroke('darkgray');
    line(xOriginPD + leftPointPD.re * 2 * windowHeight / 5, yOriginPD - leftPointPD.im * 2 * windowHeight / 5,
          xOriginPD + rightPointPD.re * 2 * windowHeight / 5, yOriginPD - rightPointPD.im * 2 * windowHeight / 5);
    stroke('dodgerblue');
  ...
  //    point(xOriginPD + leftPointPD.re * 2 * windowHeight / 5, yOriginPD - leftPointPD.im * 2 * windowHeight / 5, 25);
  //    point(xOriginPD + rightPointPD.re * 2 * windowHeight / 5, yOriginPD - rightPointPD.im * 2 * windowHeight / 5, 25);
  //}
  //pop();
  ...
  for (let index = 0; index < permX.length; index += 2) {
    ...
    push();
    strokeWeight(6);
    if (dist(xOriginPD + permLeftPointPD.re * 2 * windowHeight / 5, yOriginPD - permLeftPointPD.im * 2 * windowHeight / 5,
            xOriginPD + permRightPointPD.re * 2 * windowHeight / 5, yOriginPD - permRightPointPD.im * 2 * windowHeight / 5)
            < 2 * discRadius + 0.01 && dist(xOriginPD + permLeftPointPD.re * 2 * windowHeight / 5, yOriginPD - permLeftPointPD.im * 2 * windowHeight / 5,
            xOriginPD + permRightPointPD.re * 2 * windowHeight / 5, yOriginPD - permRightPointPD.im * 2 * windowHeight / 5)
            > 2 * discRadius - 0.01) {
      stroke('darkgray');
      line(xOriginPD + permLeftPointPD.re * 2 * windowHeight / 5, yOriginPD - permLeftPointPD.im * 2 * windowHeight / 5,
            xOriginPD + permRightPointPD.re * 2 * windowHeight / 5, yOriginPD - permRightPointPD.im * 2 * windowHeight / 5);
      stroke('dodgerblue');
      line(xOriginPD + permhz_1.re * discRadius, yOriginPD - permhz_1.im * discRadius,
            xOriginPD + permhz_2.re * discRadius, yOriginPD - permhz_2.im * discRadius);

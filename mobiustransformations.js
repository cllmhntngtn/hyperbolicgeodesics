...
function setup() {
  ...
  inputMobA.position(windowWidth / 18, 13.5 * windowHeight / 20);
  inputMobA.size(50);
  inputMobA.style('font-size', '20px');
  buttonMobA = createButton('submit');
  buttonMobA.position(inputMobA.x + inputMobA.width, 13.5 * windowHeight / 20);
  ...
  inputMobB.position(windowWidth / 18, 14.5 * windowHeight / 20);
  inputMobB.size(50);
  inputMobB.style('font-size', '20px');
  buttonMobB = createButton('submit');
  buttonMobB.position(inputMobB.x + inputMobB.width, 14.5 * windowHeight / 20);
  ...
  inputMobC.position(windowWidth / 18, 15.5 * windowHeight / 20);
  inputMobC.size(50);
  inputMobC.style('font-size', '20px');
  buttonMobC = createButton('submit');
  buttonMobC.position(inputMobC.x + inputMobC.width, 15.5 * windowHeight / 20);
  ...
  inputMobD.position(windowWidth / 18, 16.5 * windowHeight / 20);
  inputMobD.size(50);
  inputMobD.style('font-size', '20px');
  buttonMobD = createButton('submit');
  buttonMobD.position(inputMobD.x + inputMobD.width, 16.5 * windowHeight / 20);
  ...
  //buttonTransform.position(1 * windowWidth / 20, 17 * windowHeight / 20);
  ...
  //buttonDoAnotherTransformation.position(8 * windowWidth / 10, 3 * windowHeight / 20);
...
function möA() {
  var mobA = inputMobA.value();
  mobiusA[0] = mobA;
}

function möB() {
  var mobB = inputMobB.value();
  mobiusB[0] = mobB;
}

function möC() {
  var mobC = inputMobC.value();
  mobiusC[0] = mobC;
}

function möD() {
  var mobD = inputMobD.value();
  mobiusD[0] = mobD;
}
...
function draw() {
  ...
  var mobz_1 = (((z_1.mul(mobiusA[0])).add(mobiusB[0]))).div(((z_1.mul(mobiusC[0])).add(mobiusD[0])));
  var mobz_2 = (((z_2.mul(mobiusA[0])).add(mobiusB[0]))).div(((z_2.mul(mobiusC[0])).add(mobiusD[0])));
  ...
  push();
  textSize(25);
  text('Re(α)', windowWidth / 40, 1.5 * windowHeight / 20 + 10);
  text('Im(α)', windowWidth / 40, 2.5 * windowHeight / 20 + 10);
  text('Re(β)', windowWidth / 40, 4.5 * windowHeight / 20 + 10);
  text('Im(β)', windowWidth / 40, 5.5 * windowHeight / 20 + 10);
  text('a', windowWidth / 40, 12 * windowHeight / 20 + 10);
  text('b', windowWidth / 40, 13 * windowHeight / 20 + 10);
  text('c', windowWidth / 40, 14 * windowHeight / 20 + 10);
  text('d', windowWidth / 40, 15 * windowHeight / 20 + 10);
  pop();
  ...
  text('γ(z) =', windowWidth / 12 - 75, 9 * windowHeight / 20);
  let aString1 = 'az + b';
  let aString2 = 'cz + d';
  let sWidth = textWidth(aString1);
  text(aString1, windowWidth / 12, 8.5 * windowHeight / 20);
  line(windowWidth / 12, 9 * windowHeight / 20, windowWidth / 12 + sWidth, 9 * windowHeight / 20);
  text(aString2, windowWidth / 12, 9.5 * windowHeight / 20);
  text('ad - bc > 0', windowWidth / 12 - 60, 10.5 * windowHeight / 20);
  pop();
  ...
  textFont('Helvetica');
  textSize(30);
  text('α = ' + x[0].toFixed(2) + ' + ' + y[0].toFixed(2) + 'i', 4 * windowWidth / 6, 1.5 * windowHeight / 20 + 2);
  text('β = ' + x[1].toFixed(2) + ' + ' + y[1].toFixed(2) + 'i', 4 * windowWidth / 6, 3 * windowHeight / 20 + 2);
  text('α\' = ' + newReA.toFixed(2) + ' + ' + newImA.toFixed(2) + 'i', 5.25 * windowWidth / 6, 1.5 * windowHeight / 20 + 2);
  text('β\' = ' + newReB.toFixed(2) + ' + ' + newImB.toFixed(2) + 'i', 5.25 * windowWidth / 6, 3 * windowHeight / 20 + 2);
  pop();
  ...
  strokeWeight(3);
  strokeCap(SQUARE, CENTER);
  text('γ(z) =', 9 * windowWidth / 32 - 85, 2.25 * windowHeight / 20);
  let aString3 = mobiusA + 'z + ' + mobiusB[0];
  let aString4 = mobiusC[0] + 'z + ' + mobiusD[0];
  let sWidth2 = Math.max(textWidth(aString3), textWidth(aString4));
  text(aString3, 9 * windowWidth / 32, 1.75 * windowHeight / 20);
  line(9 * windowWidth / 32, 2.25 * windowHeight / 20, 9 * windowWidth / 32 + sWidth2, 2.25 * windowHeight / 20);
  text(aString4, 9 * windowWidth / 32, 2.75 * windowHeight / 20);
  pop();
}

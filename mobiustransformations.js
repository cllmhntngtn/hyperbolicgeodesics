...
function draw() {
  ...
  push();
  textSize(25);
  text('Re(α)', 1440 / 40, 1.5 * 737 / 20 + 10);
  text('Im(α)', 1440 / 40, 2.5 * 737 / 20 + 10);
  text('Re(β)', 1440 / 40, 4.5 * 737 / 20 + 10);
  text('Im(β)', 1440 / 40, 5.5 * 737 / 20 + 10);
  text('a', 1440 / 40, 12 * 737 / 20 + 10);
  text('b', 1440 / 40, 13 * 737 / 20 + 10);
  text('c', 1440 / 40, 14 * 737 / 20 + 10);
  text('d', 1440 / 40, 15 * 737 / 20 + 10);
  pop();

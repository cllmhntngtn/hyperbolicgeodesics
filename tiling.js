...
function draw() {
  ...
  text('up to (and including) 151 chips', (14.5 * 1440) / 18, 2.5 * 737 / 20 + 18);
  pop();
  ...
  if (n == 148) {chipPattern = [zero,three,three,three];}
  if (n == 149) {chipPattern = [one,three,three,three];}
  if (n == 150) {chipPattern = [two,three,three,three];}
  if (n == 151) {chipPattern = [three,three,three,three];}
}

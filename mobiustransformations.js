...
function draw() {
  ...
  if (x[0] && x[1] && y[0] && y[1]) {
    ...
    text(alphabetalabels, 4 * windowWidth / 5, windowHeight / 12);
    text(alphabetaprimelabels, 4 * windowWidth / 5, windowHeight / 12 + 54);
    noFill();
    strokeWeight(3);
    rectMode(CENTER);
    stroke('dodgerblue');
    rect(4 * windowWidth / 5, windowHeight / 12, abWidth + 20, 40, 20);
    stroke('firebrick');
    rect(4 * windowWidth / 5, windowHeight / 12 + 54, abpWidth + 20, 40, 20);
    pop();
  }

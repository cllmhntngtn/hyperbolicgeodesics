...
function draw() {
  ...
  push();
  textSize(30);
  text('at the moment this only works for', (14.5 * 1440) / 18, 1.5 * 737 / 20 + 18);
  text('up to (and including) 159 chips', (14.5 * 1440) / 18, 2.5 * 737 / 20 + 18);
  pop();
  ...
  if (n == 108) {chipPattern = [zero,three,two,two];}
  if (n == 109) {chipPattern = [one,three,two,two];}
  if (n == 110) {chipPattern = [two,three,two,two];}
  if (n == 111) {chipPattern = [three,three,two,two];}
  if (n == 112) {chipPattern = [zero,one,three,two];}
  if (n == 113) {chipPattern = [one,one,three,two];}
  if (n == 114) {chipPattern = [two,one,three,two];}
  if (n == 115) {chipPattern = [three,one,three,two];}
  if (n == 116) {chipPattern = [zero,two,three,two];}
  if (n == 117) {chipPattern = [one,two,three,two];}
  if (n == 118) {chipPattern = [two,two,three,two];}
  if (n == 119) {chipPattern = [three,two,three,two];}
  if (n == 120) {chipPattern = [zero,three,three,two];}
  if (n == 121) {chipPattern = [one,three,three,two];}
  if (n == 122) {chipPattern = [two,three,three,two];}
  if (n == 123) {chipPattern = [three,three,three,two];}
  if (n == 124) {chipPattern = [zero,one,one,three];}
  if (n == 125) {chipPattern = [zero,one,one,three];}
  if (n == 126) {chipPattern = [zero,one,one,three];}
  if (n == 127) {chipPattern = [zero,one,one,three];}
  if (n == 128) {chipPattern = [zero,two,one,three];}
  if (n == 129) {chipPattern = [one,two,one,three];}
  if (n == 130) {chipPattern = [two,two,one,three];}
  if (n == 131) {chipPattern = [three,two,one,three];}
  if (n == 132) {chipPattern = [zero,three,one,three];}
  if (n == 133) {chipPattern = [one,three,one,three];}
  if (n == 134) {chipPattern = [two,three,one,three];}
  if (n == 135) {chipPattern = [three,three,one,three];}
  if (n == 136) {chipPattern = [zero,one,two,three];}
  if (n == 137) {chipPattern = [one,one,two,three];}
  if (n == 138) {chipPattern = [two,one,two,three];}
  if (n == 139) {chipPattern = [three,one,two,three];}
  if (n == 140) {chipPattern = [zero,two,two,three];}
  if (n == 141) {chipPattern = [one,two,two,three];}
  if (n == 142) {chipPattern = [two,two,two,three];}
  if (n == 143) {chipPattern = [three,two,two,three];}
  if (n == 144) {chipPattern = [zero,three,two,three];}
  if (n == 145) {chipPattern = [one,three,two,three];}
  if (n == 146) {chipPattern = [two,three,two,three];}
  if (n == 147) {chipPattern = [three,three,two,three];}
  if (n == 148) {chipPattern = [zero,one,three,three];}
  if (n == 149) {chipPattern = [one,one,three,three];}
  if (n == 150) {chipPattern = [two,one,three,three];}
  if (n == 151) {chipPattern = [three,one,three,three];}
  if (n == 152) {chipPattern = [zero,two,three,three];}
  if (n == 153) {chipPattern = [one,two,three,three];}
  if (n == 154) {chipPattern = [two,two,three,three];}
  if (n == 155) {chipPattern = [three,two,three,three];}
  if (n == 156) {chipPattern = [zero,three,three,three];}
  if (n == 157) {chipPattern = [one,three,three,three];}
  if (n == 158) {chipPattern = [two,three,three,three];}
  if (n == 159) {chipPattern = [three,three,three,three];}
}

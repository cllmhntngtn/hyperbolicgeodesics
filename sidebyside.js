...
function setup() {
  ...
  buttonAddAnotherPair.position(1440 / 50, 9 * 737 / 10);
...
function draw() {
  ...
  const xOriginPD = 3 * 1440 / 4;
  const yOriginPD = 737 / 2;
  const discRadius = (1440 / 2 - 1440 / 6) / 2;
  ...
  const xOriginUHP = 1440 / 4;
  const yOriginUHP = 5 * 737 / 7;

  const xMinUHP = 1440 / 30;
  const xMaxUHP = 1440 / 2 - 1440 / 30;
  const yMinUHP = 5 * 737 / 7;
  const yMaxUHP = 15 * 737 / 56;

  const xStepUHP = 1440 / 20;
  const yStepUHP = 737 / 10;
  ...
  for (let index = 0; index <= permX.length; index += 2) {
    ...
    if (permX[index] && permY[index] && permX[index + 1] && permY[index + 1]) {
      text(vertexLabels[index] + ' = ' + permX[index] + ' + ' + permY[index] + 'i',
          (index * 75) + 1440 / 5, 1.5 * 737 / 30 + 2);
      text(vertexLabels[index + 1] + ' = ' + permX[index + 1] + ' + ' + permY[index + 1] + 'i',
          (index * 75) + 1440 / 5, 2.5 * 737 / 30 + 2);
    }
    //if (permX[index + 1] && permY[index + 1]) {
    //  text(vertexLabels[index + 1] + ' = ' + permX[index + 1] + ' + ' + permY[index + 1] + 'i',
    //      (index + 1.5) * 1440 / 8, 2.5 * 737 / 30 + 2);
    //}
  }
  pop();
}
